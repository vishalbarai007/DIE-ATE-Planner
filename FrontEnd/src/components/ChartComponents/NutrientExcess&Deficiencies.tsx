...
const NutrientExcess: React.FC = () => {
  ...
  return (
    <div
      className={`h-fit w-full rounded-lg shadow-input border-2 border-blue-500 shadow-blue-500/50 hover:shadow-[0_0_10px_5px_rgba(0,119,255,1)] hover:border-blue-500 transition-all duration-300 ${context?.theme==='dark'?'bg-gray-900':'bg-blue-100'}`}
    >
